 ...
 */
export const getObject = (key) => requestOperationFromDb((keyStore) => keyStore.get(key))
 ...
 */
export const deleteObject = (key) => requestOperationFromDb((keyStore) => keyStore.delete(key))
 ...
 */
export const purgeDatabase = () => requestOperationFromDb((keyStore) => keyStore.clear())

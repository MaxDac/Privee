...
describe("askNotificationPermission", () => {
  it(
    "asks for permission, browser does not support notifications, reports the right result",
    () => {
      const dom = getDom()
  ...
  it(
    "asks for permission, user accepts, reports the right result",
    async () => {
      const dom = getDom()
      const window = {
        ...dom.window,
  ...
  it(
    "asks for permission, user denies, reports the right result",
    async () => {
      const dom = getDom()
      const window = {
        ...dom.window,
...
describe("pushBackEndNotification", () => {
  it(
    "checking focus, does not trigger notification if the document is visible",
    async () => {
      const dom = getDom()
  ...
  it(
    "checking focus, does trigger notification if the document is not visible",
    async () => {
      const dom = getDom()
  ...
  it(
    "not checking focus, does trigger notification independent of the document visibility",
    async () => {
      const dom = getDom()

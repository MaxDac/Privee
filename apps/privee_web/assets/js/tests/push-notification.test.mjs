...
describe("Ask notification permission", () => {
  test.serial("asks for permission, browser does not support notifications, reports the right result", t => {
    const dom = getDom()
  ...
  test.serial("asks for permission, user accepts, reports the right result", async t => {
    const dom = getDom()
    const window = {
      ...dom.window,
      Notification: {
  ...
  test.serial("asks for permission, user denies, reports the right result", async t => {
    const dom = getDom()
    const window = {
      ...dom.window,
      Notification: {
